...
function Button({ children, disabled, to, type, onClick }) {
  ...
  if (onClick)
    return (
      <div onClick={onClick} disabled={disabled} className={styles[type]}>
        {children}
      </div>
    );
